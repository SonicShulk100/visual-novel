label chapter_2_part_1:
    ...
    "The day began with the morning sun shining through the trees, casting dappled light on the forest floor."

    show mari neutral at right
    show jess neutral at left
    with dissolve

    "Maria and Jessica were waking up together, enjoying the peacefulness of the forest."

    mari "*Yawning* Good morning, Jessica."

    jess "Morning, Maria. Did you sleep well?"
